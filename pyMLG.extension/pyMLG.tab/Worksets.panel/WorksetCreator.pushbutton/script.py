...
def _zeige_fehler(spur):
    ...
    try:
        ...
        ui.meldung(letzte_zeile + (u"\n\nProtokoll: %s" % protokoll
                                   if protokoll else u""),
                   titel=TITEL, hauptzeile=u"Workset-Creator ist fehlgeschlagen",
                   warnung=True)
    except Exception:
        pass
